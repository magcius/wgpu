...
void main() {
    ...
    _fs2p_location0 = output_.vec4f;
    _fs2p_location1 = output_.vec4i;
    _fs2p_location2 = output_.vec4u;
    _fs2p_location3 = output_.vec3f;
    _fs2p_location4 = output_.vec3i;
    _fs2p_location5 = output_.vec3u;
    return;
}
