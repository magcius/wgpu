...
void test_msl_packed_vec3_() {
    ...
    _group_0_binding_1_cs.v3_[idx] = 3.0;
...
void main() {
    ...
    wg[7] = (_group_0_binding_7_cs[0][0] * _group_0_binding_6_cs[0][0][0]).x;
    wg[6] = (_group_0_binding_5_cs * _group_0_binding_4_cs).x;
    wg[5] = _group_0_binding_2_cs[1].y;
    wg[4] = _group_0_binding_3_cs[0].w;
    wg[3] = _group_0_binding_1_cs.v1_;
    wg[2] = _group_0_binding_1_cs.v3_.x;
