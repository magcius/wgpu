...
void main() {
    ...
    mat3x3 inv_model_view = transpose(mat3x3(_group_0_binding_0_vs.view[0].xyz, _group_0_binding_0_vs.view[1].xyz, _group_0_binding_0_vs.view[2].xyz));
    vec4 unprojected = (_group_0_binding_0_vs.proj_inv * pos);
