...
fn main_1() {
    ...
    v_Normal = (global_1.Model * vec4<f32>(_e11.x, _e11.y, _e11.z, 1f)).xyz;
    let _e19 = global_1.Model;
    v_Normal = (mat3x3<f32>(_e19[0].xyz, _e19[1].xyz, _e19[2].xyz) * Vertex_Normal_1);
    let _e32 = Vertex_Position_1;
    v_Position = (global_1.Model * vec4<f32>(_e32.x, _e32.y, _e32.z, 1f)).xyz;
    v_Uv = Vertex_Uv_1;
    let _e43 = v_Position;
    gl_Position = (global.ViewProj * vec4<f32>(_e43.x, _e43.y, _e43.z, 1f));
    return;
}
