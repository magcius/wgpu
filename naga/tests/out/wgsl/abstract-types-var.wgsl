...
fn mixed_constant_and_runtime_arguments() {
    ...
    xvupuai_1 = vec2<u32>(u, 43u);
    xvupaiu_1 = vec2<u32>(42u, u);
    xvuuai_1 = vec2<u32>(u, 43u);
    xvuaiu_1 = vec2<u32>(42u, u);
    xmfp_faiaiai_1 = mat2x2<f32>(vec2<f32>(f, 2f), vec2<f32>(3f, 4f));
    xmfpai_faiai_1 = mat2x2<f32>(vec2<f32>(1f, f), vec2<f32>(3f, 4f));
    xmfpaiai_fai_1 = mat2x2<f32>(vec2<f32>(1f, 2f), vec2<f32>(f, 4f));
    xmfpaiaiai_f_1 = mat2x2<f32>(vec2<f32>(1f, 2f), vec2<f32>(3f, f));
    xaf_faf_1 = array<f32, 2>(f, 2f);
    xafaf_f_1 = array<f32, 2>(1f, f);
    xaf_fai = array<f32, 2>(f, 2f);
    xafai_f = array<f32, 2>(1f, f);
    xai_iai_1 = array<i32, 2>(i, 2i);
    xaiai_i_1 = array<i32, 2>(1i, i);
    xafp_faf = array<f32, 2>(f, 2f);
    xafpaf_f = array<f32, 2>(1f, f);
    xafp_fai = array<f32, 2>(f, 2f);
    xafpai_f = array<f32, 2>(1f, f);
    xaip_iai = array<i32, 2>(i, 2i);
    xaipai_i = array<i32, 2>(1i, i);
    return;
}
