...
fn testTex1D(coord: f32) {
    ...
    levels = i32(_e24);
    let _e29 = textureSample(tex1D, samp, coord_1);
    c = _e29;
    let _e33 = textureSampleGrad(tex1D, samp, coord_1, 4f, 4f);
    c = _e33;
    let _e38 = textureSampleGrad(tex1D, samp, coord_1, 4f, 4f, 5i);
    c = _e38;
    let _e41 = textureSampleLevel(tex1D, samp, coord_1, 3f);
    c = _e41;
    let _e45 = textureSampleLevel(tex1D, samp, coord_1, 3f, 5i);
    c = _e45;
    let _e48 = textureSample(tex1D, samp, coord_1, 5i);
    c = _e48;
    let _e51 = vec2<f32>(coord_1, 6f);
    let _e55 = textureSample(tex1D, samp, (_e51.x / _e51.y));
    c = _e55;
    let _e60 = vec4<f32>(coord_1, 0f, 0f, 6f);
    let _e66 = textureSample(tex1D, samp, (_e60.xyz / vec3(_e60.w)).x);
    c = _e66;
    let _e69 = vec2<f32>(coord_1, 6f);
    let _e75 = textureSampleGrad(tex1D, samp, (_e69.x / _e69.y), 4f, 4f);
    c = _e75;
    let _e80 = vec4<f32>(coord_1, 0f, 0f, 6f);
    let _e88 = textureSampleGrad(tex1D, samp, (_e80.xyz / vec3(_e80.w)).x, 4f, 4f);
    c = _e88;
    let _e91 = vec2<f32>(coord_1, 6f);
    let _e98 = textureSampleGrad(tex1D, samp, (_e91.x / _e91.y), 4f, 4f, 5i);
    c = _e98;
    let _e103 = vec4<f32>(coord_1, 0f, 0f, 6f);
    let _e112 = textureSampleGrad(tex1D, samp, (_e103.xyz / vec3(_e103.w)).x, 4f, 4f, 5i);
    c = _e112;
    let _e115 = vec2<f32>(coord_1, 6f);
    let _e120 = textureSampleLevel(tex1D, samp, (_e115.x / _e115.y), 3f);
    c = _e120;
    let _e125 = vec4<f32>(coord_1, 0f, 0f, 6f);
    let _e132 = textureSampleLevel(tex1D, samp, (_e125.xyz / vec3(_e125.w)).x, 3f);
    c = _e132;
    let _e135 = vec2<f32>(coord_1, 6f);
    let _e141 = textureSampleLevel(tex1D, samp, (_e135.x / _e135.y), 3f, 5i);
    c = _e141;
    let _e146 = vec4<f32>(coord_1, 0f, 0f, 6f);
    let _e154 = textureSampleLevel(tex1D, samp, (_e146.xyz / vec3(_e146.w)).x, 3f, 5i);
    c = _e154;
    let _e157 = vec2<f32>(coord_1, 6f);
    let _e162 = textureSample(tex1D, samp, (_e157.x / _e157.y), 5i);
    c = _e162;
    let _e167 = vec4<f32>(coord_1, 0f, 0f, 6f);
    let _e174 = textureSample(tex1D, samp, (_e167.xyz / vec3(_e167.w)).x, 5i);
    c = _e174;
    let _e178 = textureLoad(tex1D, i32(coord_1), 3i);
    c = _e178;
    let _e183 = textureLoad(tex1D, i32(coord_1), 3i);
    c = _e183;
    return;
}
...
fn testTex1DArray(coord_2: vec2<f32>) {
    ...
    c_1 = _e68;
    let _e70 = vec2<i32>(coord_3);
    let _e74 = textureLoad(tex1DArray, _e70.x, _e70.y, 3i);
    c_1 = _e74;
    let _e76 = vec2<i32>(coord_3);
...
fn testTex2D(coord_4: vec2<f32>) {
    ...
    levels_2 = i32(_e24);
    let _e29 = textureSample(tex2D, samp, coord_5);
    c_2 = _e29;
    let _e32 = textureSampleBias(tex2D, samp, coord_5, 2f);
    c_2 = _e32;
    let _e38 = textureSampleGrad(tex2D, samp, coord_5, vec2(4f), vec2(4f));
    c_2 = _e38;
    let _e46 = textureSampleGrad(tex2D, samp, coord_5, vec2(4f), vec2(4f), vec2(5i));
    c_2 = _e46;
    let _e49 = textureSampleLevel(tex2D, samp, coord_5, 3f);
    c_2 = _e49;
    let _e54 = textureSampleLevel(tex2D, samp, coord_5, 3f, vec2(5i));
    c_2 = _e54;
    let _e58 = textureSample(tex2D, samp, coord_5, vec2(5i));
    c_2 = _e58;
    let _e63 = textureSampleBias(tex2D, samp, coord_5, 2f, vec2(5i));
    c_2 = _e63;
    let _e64 = coord_5;
    ...
    c_2 = _e279;
    let _e283 = textureLoad(tex2D, vec2<i32>(coord_5), 3i);
    c_2 = _e283;
    let _e287 = textureLoad(utex2D, vec2<i32>(coord_5), 3i);
    c_2 = vec4<f32>(_e287);
    let _e292 = textureLoad(itex2D, vec2<i32>(coord_5), 3i);
    c_2 = vec4<f32>(_e292);
    let _e299 = textureLoad(tex2D, vec2<i32>(coord_5), 3i);
    c_2 = _e299;
    let _e305 = textureLoad(utex2D, vec2<i32>(coord_5), 3i);
    c_2 = vec4<f32>(_e305);
    let _e312 = textureLoad(itex2D, vec2<i32>(coord_5), 3i);
    c_2 = vec4<f32>(_e312);
    return;
}
...
fn testTex2DArray(coord_8: vec3<f32>) {
    ...
    c_3 = _e91;
    let _e93 = vec3<i32>(coord_9);
    let _e97 = textureLoad(tex2DArray, _e93.xy, _e93.z, 3i);
    c_3 = _e97;
    let _e99 = vec3<i32>(coord_9);
...
fn testTexCube(coord_12: vec3<f32>) {
    ...
    levels_6 = i32(_e24);
    let _e29 = textureSample(texCube, samp, coord_13);
    c_4 = _e29;
    let _e32 = textureSampleBias(texCube, samp, coord_13, 2f);
    c_4 = _e32;
    let _e38 = textureSampleGrad(texCube, samp, coord_13, vec3(4f), vec3(4f));
    c_4 = _e38;
    let _e41 = textureSampleLevel(texCube, samp, coord_13, 3f);
    c_4 = _e41;
    return;
}
...
fn testTex3D(coord_20: vec3<f32>) {
    ...
    levels_10 = i32(_e24);
    let _e29 = textureSample(tex3D, samp, coord_21);
    c_6 = _e29;
    let _e32 = textureSampleBias(tex3D, samp, coord_21, 2f);
    c_6 = _e32;
    let _e33 = coord_21;
    ...
    c_6 = _e140;
    let _e146 = textureSampleGrad(tex3D, samp, coord_21, vec3(4f), vec3(4f));
    c_6 = _e146;
    let _e154 = textureSampleGrad(tex3D, samp, coord_21, vec3(4f), vec3(4f), vec3(5i));
    c_6 = _e154;
    let _e157 = textureSampleLevel(tex3D, samp, coord_21, 3f);
    c_6 = _e157;
    let _e162 = textureSampleLevel(tex3D, samp, coord_21, 3f, vec3(5i));
    c_6 = _e162;
    let _e166 = textureSample(tex3D, samp, coord_21, vec3(5i));
    c_6 = _e166;
    let _e171 = textureSampleBias(tex3D, samp, coord_21, 2f, vec3(5i));
    c_6 = _e171;
    let _e175 = textureLoad(tex3D, vec3<i32>(coord_21), 3i);
    c_6 = _e175;
    let _e181 = textureLoad(tex3D, vec3<i32>(coord_21), 3i);
    c_6 = _e181;
    return;
}
...
fn testTex2DMS(coord_22: vec2<f32>) {
    ...
    let _e27 = textureLoad(tex2DMS, vec2<i32>(coord_23), 3i);
    c_7 = _e27;
    return;
}
